...
/**
 * @author i.heldyieu This Class provides Clients (mobile customers) information
 *         such as: <li>Surname : String</li> <li>Passport : String</li> <li>
 *         Gender : Gender<Enum></li> Clients can subscribe on several tarrifs
 *         or can unsubscribe from one/all tarrifs.
 * @see java.lang.Enum
 */
public class Client {
